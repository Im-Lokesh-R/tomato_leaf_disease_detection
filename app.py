...
def model_predict(img_path, model):
   ...
   # x = preprocess_input(x)
    ...
    if preds==0:
        ...
        preds="The Disease is Tomato Late blight"
    elif preds==3:
        preds="Te Disease is Leaf Mold"
    elif preds==4:
        preds="The Disease is Bacterial_spot"
    elif preds==5:
        preds="The Disease is Tomato mosaic virus"
    elif preds==6:
        preds="The Disease is Tomato YellowLeaf Curl Virus"
    elif preds==7:
        preds="The Disease is Tomato Tomato YellowLeaf Curl Virus"
    elif preds==8:
